...
automl_run_id = 'sharp_drop_z6m168dy1v_40'
...
def generate_data_transformation_config():
    ...
    column_group_0 = [['eid'], ['hematocrit'], ['neutrophils'], ['sodium'], ['glucose'], ['bloodureanitro'], ['creatinine'], ['bmi'], ['pulse'], ['respiration']]
    
    column_group_3 = ['gender', 'dialysisrenalendstage', 'asthma', 'irondef', 'pneum', 'substancedependence', 'psychologicaldisordermajor', 'depress', 'psychother', 'fibrosisandother', 'malnutrition', 'hemo']
    
    column_group_1 = ['vdate', 'discharged']
    
    column_group_2 = ['rcount', 'secondarydiagnosisnonicd9', 'facid']
...
def generate_algorithm_config():
    ...
    algorithm = PreFittedSoftVotingRegressor(
        ...
        weights=[0.6666666666666666, 0.26666666666666666, 0.06666666666666667]
    )
...
if __name__ == '__main__':
    ...
    parser.add_argument('--training_dataset_uri', type=str, default='azureml://locations/westus/workspaces/057d873a-dcb0-4835-819a-c432ac9d4477/data/ms_los/versions/1',     help='Default training dataset uri is populated from the parent run')
